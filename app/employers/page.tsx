          ...
          <div className="rounded-[1.7rem] border border-slate-100 bg-white p-6 shadow-lg shadow-slate-100 md:p-8">
            ...
            <div className="space-y-5 text-sm leading-8 text-slate-600 md:text-base">
              ...
              <p>
                ...
                supporting communication, and helping suitable candidates
                progress through the process.
              </p>

              <p>
                This approach is especially important in healthcare, where
                hiring decisions affect patient care, team stability, service
                quality, and long-term workforce planning.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-0 md:grid-cols-[0.9fr_1.1fr]">
            <div className="relative p-7 text-white md:p-10">
              ...
              <p className="mt-5 text-sm leading-7 text-slate-300 md:text-base">
                ...
                patient care, communication, responsibility, and stability matter
                every day.
              </p>
